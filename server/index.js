      ...
      <div className="max-w-4xl mx-auto p-4">
        <div className="text-center mb-6 glass-panel p-6">
          <div className="flex justify-center mb-3">
            <Video size={40} className="text-blue-400 float-animation" />
          </div>
          <h1 className="text-3xl font-bold text-white mb-2 bg-gradient-to-r from-blue-400 to-indigo-400 inline-block text-transparent bg-clip-text">
            YouTube Video Combiner
          </h1>
          <p className="text-white/70">Combine multiple YouTube videos into a single file</p>
        </div>
